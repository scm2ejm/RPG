...
/**
 * An <CODE>Icon</CODE> that repeats its image horizontally and vertically to fill the component
 * area, excluding any border or insets.
 * <P>
 ...
 * <CODE>TileIcon</CODE> must only be used in conjunction with a component and layout that does not
 * depend on the size of the component's Icon.
 *
...
public class TileIcon extends ImageIcon {
  ...
  public enum TileMode {
    ...
    /**
     * The default for a newly constructed <CODE>TileIcon</CODE>. The image will be tiled starting
     * at the top left of the component.
     */
    DEFAULT,
    /**
     * The image will be tiled such that the intersection of tile corners will be placed at the
     * center of the tiled area.
     */
    CENTER_CORNER,
    /**
     * The image will be tiled such that the center of a tile will be placed at the center of the
     * tiled area.
     */
    CENTER_CENTER
  };
  ...
  /**
   * Sets the tiling mode. If not explicitly set or if set to <CODE>TileMode.DEFAULT</CODE>, the
   * image will be tiled starting from the top left corner of the component.
   * 
   * @param tileMode the tiling style. One of the following constants defined in enum
   *        <code>TileMode</code>:
   *        <ul>
   ...
   * 
   * @return the TileMode of this Icon: <code>DEFAULT</code>, <code>CENTER_CENTER</code> or
   *         <code>CENTER_CORNER</code>
   */
